...
<html lang="en">
    ...
    <body style="font-family: league spartan">
        ...
        <div class="container-fluid text-center px-4" style="margin-top: 50px;margin-bottom:100px;text-align:justify">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="row" style="font-size: 20px">
                    <div
                        class="col-3 offset-1 md-4 text-start"
                ...
                <div class="row" style="font-size: 20px">
                    <div
                        class="col-1 offset-1 md-4 text-start"
                        style="margin-top: 50px"
                    >
                        <h3>Visi :</h3>
                    </div>
