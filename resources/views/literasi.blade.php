...
<body style="font-family: league spartan">
  ...
  <div class="container-fluid" style="margin-top: 70px;">
    ...
    <div class="row mt-3">
      <div class="col-10 offset-1 py-2"
        style="background-image: linear-gradient(to right, #63c0c8, #42cfad); font-size:30px;color:white;font-weight:500;margin-top:40px;margin-bottom:60px;padding-left:20px">
        TEKNOLOGI</div>
    </div>
  </div>
  ...
  <div class="container" style="background-image: linear-gradient(#63c0c8, #42cfad)">
    <div class="row">
